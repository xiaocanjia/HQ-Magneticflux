...
public struct TTerminalStatus
{
    ...
    public UInt32 reserve7;
        ...
        [DllImport("gts.dll")]
        public static extern short GTN_SetEcatAxisPV(short core,short axis,Int64 velocity);
        [DllImport("gts.dll")]
        ...
        [DllImport("gts.dll")]
        public static extern short GTN_SetEcatSlavePdo(short core, short slaveIndex, ushort objectWord, ushort objectSubIndex, ref byte pValue, uint data_size);
        [DllImport("gts.dll")]
        public static extern short GTN_GetEcatSlavePdo(short core, short slaveIndex, ushort objectWord, ushort objectSubIndex, ref byte pValue, uint data_size);
        ...
        public struct TEcatErrInfo
       {
        ...
        public struct TPosComparePulse
        {
            ...
            public short reserve10;
            public short reserve11;
            public double hightLevelTime;
            public double lowLevelTime;
            public double reserve20;
            public double reserve21;
            public double reserve22;
            public double reserve23;
        };
        [DllImport("gts.dll")]
        public static extern short GTN_PosComparePulseEx(short core, short index, ref TPosComparePulse pPrm);
